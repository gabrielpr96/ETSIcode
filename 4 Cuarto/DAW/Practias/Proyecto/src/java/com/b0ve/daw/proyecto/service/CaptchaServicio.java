...
public class CaptchaServicio {

    private final static CaptchaServicio instance = new CaptchaServicio();

    public static CaptchaServicio instance() {
        return instance;
    }

    public static final String url = "https://www.google.com/recaptcha/api/siteverify";
    public static final String secreto = "6LcUXYAdAAAAAOwcspxTD5A3FRz03B7epq6TNZ1i";
    private final static String USER_AGENT = "Mozilla/5.0";

    public boolean verificar(String gRecaptchaResponse) throws IOException {
