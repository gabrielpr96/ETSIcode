...
public class OutputStubWindow extends javax.swing.JFrame {
    ...
    private void listMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listMouseClicked
        Message message = list.getModel().getElementAt(list.locationToIndex(evt.getPoint()));
        bodyTest.setText(prettyPrintMessage(message));
    }//GEN-LAST:event_listMouseClicked

    private void act() {
        Message[] messages = adapter.getMessages();
    ...
    private javax.swing.JList<Message> list;
