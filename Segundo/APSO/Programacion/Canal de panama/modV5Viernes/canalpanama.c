...
int main()
{
 ...
 int pservidorgraf, i, pidgesclusae, pidgesclusao, pidglago, rnd, colaaviones;
 int tubo[2];
 struct Parametros param;
 struct testigoAviones tAviones; tAviones.id = 1;
 ...
 //Crea la cola de aviones y mete un testigo
 ...
 //Borra la cola de los aviones
 msgctl (colaaviones, IPC_RMID, 0);
}
