...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private int actualN;
    private TDatosAlmacen actual;

    public MenuPrincipal(GestionAlmacenesIntf stub) {
        this.stub = stub;
        initComponents();
        actualN = -1;
        actualizarActual();
    ...
    private void initComponents() {
        ...
        itemRebajarProducto = new javax.swing.JMenuItem();
        ...
        itemRebajarProducto.setText("Rebajar producto");
        itemRebajarProducto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itemRebajarProductoActionPerformed(evt);
            }
        });
        jMenu2.add(itemRebajarProducto);
    ...
    private void itemRebajarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemRebajarProductoActionPerformed
        new RebajarProducto(stub, this);
    }//GEN-LAST:event_itemRebajarProductoActionPerformed

    public void setActual(TDatosAlmacen actual, int actualN) {
        this.actual = actual;
    ...
    public TDatosAlmacen getActualDatos() {
        return actual;
    }
    ...
    private void actualizarActual() {
        if (actual == null) {
            ...
            labelAbierto.setText("<html><body>Almacen abierto: " + actual.getNombre() + "<br>Direccion: " + actual.getDireccion() + "<br>Fichero: " + actual.getFichero() + "<br>Número: " + actualN + "</body></html>");
        }
        ...
        itemRebajarProducto.setEnabled(actual != null);
    ...
    private javax.swing.JMenuItem itemRebajarProducto;
