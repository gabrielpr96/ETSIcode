...
public class Interfaz extends JPanel {
    ...
    private static final String[] ALGORITMOS = {"Exhaustivo lineas", "DyV lineas", "Exhaustivo triangulos", "DyV triangulos", "Kruskal", "Prim", "Kruskal Simplificado", "Prim Simplificado", "Dijkstra"};
    ...
    /**
     * Detiene el trabajdor actual si lo hubiera, esperando a que termine, y
     * comienza uno nuevo con el algoritmo seleccionado y los puntos cargados
     */
            ...
            public void run() {
                switch (cboAlgoritmo.getSelectedIndex()) {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        Algoritmos.DrawDijkstra(puntos, lienzo, txtMensaje);
                        break;
                }
            }
        };
