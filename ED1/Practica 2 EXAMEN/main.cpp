...
char menu(){
    ...
    printn(32,5); printn(186,1);printn(32,24); cout << "9. Modificar un cliente"; printn(32,21);printn(186,1); cout << "\n";
    printn(32,5); printn(186,1); printn(32,68); printn(186,1); cout << "\n";
    printn(32,5); printn(186,1);printn(32,24); cout << "A. Ultimo cliente"; printn(32,27);printn(186,1); cout << "\n";
    printn(32,5); printn(186,1); printn(32,68); printn(186,1); cout << "\n";
...
int main(){
    peluqueria p;
    //p.AbrirPeluqueria("guardado.dat"); //Eliminar
    ...
    do{
        ...
        switch(opt){
            ...
            break;
            case '9':
            //Recive nombre y apellido de un cliente. Cambia todos sus datos menos el tipo de servicio. Lo deja en la posición que estaba.
                printTitulo("Modificar un cliente");
                cadena cNombre, cApellidos;
                cliente cTMP;

                cin.ignore();
                cout << "\tNombre del cliente: ";
                cin.getline(cNombre, sizeof(cadena));
                cout << "\tApellidos del cliente: ";
                cin.getline(cApellidos, sizeof(cadena));

                if(p.ExisteCliente(cNombre, cApellidos)){
                    cout << "\n\tNuevo nombre: ";
                    cin.getline(cTMP.Nombre, sizeof(cadena));
                    cout << "\tNuevos apellidos: ";
                    cin.getline(cTMP.Apellidos, sizeof(cadena));
                    cout << "\tNueva edad: ";
                    cin >> cTMP.Edad;
                    cout << "\tNueva hora de llegada (horas minutos): ";
                    int h, m;
                    cin >> h >> m;
                    cTMP.HoraLlegada = h*60+m;
                    p.ModificarCliente(cNombre, cApellidos, cTMP);
            ...
            case 'a':
            case 'A':
            //Mostrar los datos del cliente que lleva menos tiempo esperando.
                printTitulo("Mostrar ultimo cliente");

                p.MostrarUltimoCliente();
                cin.ignore();
            break;
        }
        if(opt != '0'){
