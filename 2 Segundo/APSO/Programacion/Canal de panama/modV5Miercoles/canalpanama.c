...
int main()
{
 ...
 int pservidorgraf, i, pidgesclusae, pidgesclusao, pidglago, piddocucanal;
 int tubo[2];
 ...
 piddocucanal = creaproceso("docucanal", NULL);
 ...
 printf("Han solicitado la documentacion %d barcos.\n", llega16);
...
/*
 *maxbarcos=5; //Numero de barcos que se crearan
 ...
 *caplago=4;   //Capacidad del lago
 ...
 param->lagomax=15;   //Intervalo de tiempo en cruzar el lago MAX
 param->mevoymin=5;  //Intervalo de tiempo en esperar para irse MIN
 param->mevoymax=5;  //Intervalo de tiempo en esperar para irse MAX
*/
