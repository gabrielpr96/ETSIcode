...
public class VentanaGestionGlobal extends java.awt.Frame {
    ...
    private void initComponents() {
        ...
        inacabados = new javax.swing.JButton();
        casoIncabadosFechaInicio = new com.toedter.calendar.JDateChooser();
        ...
        inacabados.setText("Inacabados");
        inacabados.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inacabadosActionPerformed(evt);
            }
        });

        casoIncabadosFechaInicio.setDateFormatString("yyyy/MM/dd");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(casoIncabadosFechaInicio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel17)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(casoIncabadosFechaInicio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void inacabadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inacabadosActionPerformed
        Date fInicio = eliminarHora(casoIncabadosFechaInicio.getDate());
        ArrayList<Caso> casos;
        try {
            if (fInicio == null) {
                casos = mca.listaCasosInacabados();
            } else {
                casos = mca.listaCasosInacabadosPorFecha(espFecha.format(fInicio));
            }
            if (casos.isEmpty()) {
                JOptionPane.showMessageDialog(this, "No existen casos inacabados desde esa fecha", "Error al listar casos inacabados", JOptionPane.INFORMATION_MESSAGE);
            } else {
                limpiarCasos();
                for (Caso caso : casos) {
            ...
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Error al listar casos inacabados", JOptionPane.ERROR_MESSAGE);
        }

    }//GEN-LAST:event_inacabadosActionPerformed
    ...
    private com.toedter.calendar.JDateChooser casoIncabadosFechaInicio;
    ...
    private javax.swing.JButton inacabados;
