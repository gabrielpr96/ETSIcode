 ...
 * @author borja
 */
public class VentanaGestionColaboraciones extends java.awt.Frame {
     ...
     * @param conexion
     */
    public VentanaGestionColaboraciones(ConexionOracle conexion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxExperto = new javax.swing.JComboBox<Persistencia.Experto>();
    ...
    private void jComboBoxExpertoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxExpertoActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, ex.getMessage(), "Error al listar colaboracion", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private javax.swing.JComboBox<Persistencia.Experto> jComboBoxExperto;
