...
public class VentanaGestionGlobal extends java.awt.Frame {
    ...
    private void initComponents() {
        ...
        filtroDescripcion = new javax.swing.JTextField();
        ...
        filtroDescripcion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                filtroDescripcionActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(filtroDescripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void filtroDescripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filtroDescripcionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_filtroDescripcionActionPerformed

    private void btnFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiltrarActionPerformed
        int expertoSeleccionado = tablaExpertos.getSelectedRow();
        if (expertoSeleccionado != -1) {
            String codExperto = (String) modeloExpertos.getValueAt(expertoSeleccionado, 0);
            try {
                ArrayList<Colabora> colaboraciones = filtroDescripcion.getText().isEmpty() ? mco.listaColaboradoresPorExperto(codExperto) : mco.listaColaboradoresPorExpertoPorDescripcion(codExperto, filtroDescripcion.getText());
                limpiarColaboraciones();
                ...
                Logger.getLogger(VentanaGestionGlobal.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField filtroDescripcion;
