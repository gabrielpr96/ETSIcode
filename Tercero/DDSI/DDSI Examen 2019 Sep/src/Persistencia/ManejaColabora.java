...
public class ManejaColabora {
     ...
     * @throws SQLException si ocurre alguna anomalía
     */
    public ArrayList<Colabora> listaColaboradoresPorExperto(String codExperto) throws SQLException {
        ArrayList<Colabora> lista = new ArrayList<>();
        ps = conexion.getConexionOracle().prepareStatement("SELECT * FROM COLABORA WHERE CODEXPERTO = ?");
        ps.setString(1, codExperto);
        ResultSet rs = ps.executeQuery();
     ...
     * @throws SQLException si ocurre alguna anomalía
     */
    public ArrayList<Colabora> listaColaboradoresPorExpertoPorDescripcion(String codExperto, String descripcion) throws SQLException {
        ArrayList<Colabora> lista = new ArrayList<>();
        ps = conexion.getConexionOracle().prepareStatement("SELECT * FROM COLABORA WHERE CODEXPERTO = ? AND DESCRIPCION_COLABORACION = ?");
        ps.setString(1, codExperto);
