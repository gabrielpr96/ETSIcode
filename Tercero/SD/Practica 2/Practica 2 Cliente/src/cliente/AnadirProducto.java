...
public class AnadirProducto extends javax.swing.JFrame {
    ...
    public AnadirProducto(IGestionAlmacenes stub, MenuPrincipal padre) {
        this.stub = stub;
        this.padre = padre;
        initComponents();
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        try {
            stub.anadirProducto(padre.getActual().getFichero(), new Producto(inputCodigo.getText(), Integer.parseInt(inputCantidad.getText()), inputNombre.getText(), Float.parseFloat(inputPrecio.getText()), inputDescripcion.getText(), new Fecha(Integer.parseInt(inputDia.getText()), Integer.parseInt(inputMes.getText()), Integer.parseInt(inputAnyo.getText()))));
            dispose();
