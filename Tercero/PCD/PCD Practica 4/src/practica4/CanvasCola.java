...
public class CanvasCola extends Canvas{
    ...
    /**
     * Actualiza el mensaje a mostrar en el canvas y lo pinta.
    ...
    /**
     * Actualiza el estado de la cola y dibuja el canvas.
     * @param buf Array con los elementos de la cola
     * @param head Posición de la cabeza
     * @param tail Posición de la cola
     * @param numele Número de elementos en la cola
     */
