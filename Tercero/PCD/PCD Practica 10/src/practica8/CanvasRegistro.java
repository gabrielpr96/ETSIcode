...
public class CanvasRegistro extends Canvas {
     ...
     */
    public void entraClienteRegistro(int id) {
        cola.add(new Cliente(id, true));
        repaint();
    }
     ...
     */
    public void entraClienteNota(int id) {
        cola.add(new Cliente(id, false));
        repaint();
    }
     ...
     * antendiendo
     */
    public void saleCliente(int id) {
     ...
     */
    public void atendidoPorRegistrador(int id) {
        Cliente c = cola.stream().filter(cliente -> cliente.getId() == id).findFirst().orElse(null);
     ...
     */
    public void atendidoPorOficial(int id) {
        Cliente c = cola.stream().filter(cliente -> cliente.getId() == id).findFirst().orElse(null);
        c.atendidoOficinal();
        libresOficinal--;
        repaint();
