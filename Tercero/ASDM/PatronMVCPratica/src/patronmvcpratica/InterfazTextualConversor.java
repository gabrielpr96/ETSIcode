    ...
    private void procesaNuevaOperacion() {
        ...
        switch (nroOperacion) {
            ...
            case 6:
                ...
                break;
            case 7:
                controlador.actionPerformed(new ActionEvent(this, nroOperacion, CCAMBIO_INTERFAZ_CLI));
                break;
            case 8:
                controlador.actionPerformed(new ActionEvent(this, nroOperacion, CCAMBIO_INTERFAZ_GUI));
                break;
            default:
                OperacionIncorrecta();
        }
