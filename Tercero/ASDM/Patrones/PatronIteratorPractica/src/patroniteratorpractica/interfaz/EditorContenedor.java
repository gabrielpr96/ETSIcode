...
public class EditorContenedor extends javax.swing.JFrame {

    private final DefaultListModel<String> mLista;
    private final Contenedor contenedor;

    public EditorContenedor(Contenedor contenedor) {
    ...
    private void initComponents() {
        ...
        setTitle("Contenedor Borja López");
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        int pos = listaElementos.getSelectedIndex();
        if (pos != -1) {
            contenedor.agregar(pos, inputTexto.getText());
        } else {
            contenedor.agregar(inputTexto.getText());
        }
        inputTexto.setText("");
        actualizar();
