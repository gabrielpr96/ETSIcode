...
public class EditorContenedorAsociativo extends javax.swing.JFrame {

    private final DefaultListModel<String> mLista;
    private final ContenedorAsociativo contenedor;

    public EditorContenedorAsociativo(ContenedorAsociativo contenedor) {
    ...
    private void initComponents() {
        ...
        setTitle("Contenedor asociativo Borja López");
        ...
        jLabel1.setText("Contenedor asociativo");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        contenedor.eliminar(inputClave.getText());
        inputClave.setText("");
        actualizar();
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        contenedor.agregar(inputClave.getText(), inputValor.getText());
        inputClave.setText("");
        inputValor.setText("");
        actualizar();
    ...
    private void actualizar() {
        ...
        Object[] datos = contenedor.getDatos();
        for (Object dato : datos) {
            mLista.addElement(dato.toString());
        }
    }
