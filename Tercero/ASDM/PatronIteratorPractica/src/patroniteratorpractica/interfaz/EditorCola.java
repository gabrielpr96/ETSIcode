...
public class EditorCola extends javax.swing.JFrame {

    private final DefaultListModel<String> mLista;
    private final Cola cola;

    public EditorCola(Cola lista) {
    ...
    private void initComponents() {
        ...
        btnEliminar.setText("Eliminar primero");
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        cola.agregar(inputTexto.getText());
        inputTexto.setText("");
        actualizar();
    ...
    private void actualizar() {
        ...
        IIterador iterador = cola.getIterador();
