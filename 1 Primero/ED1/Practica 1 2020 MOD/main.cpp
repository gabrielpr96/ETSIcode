...
int menuMain() {
    ...
    do {
        cout<< "----- Menu principal -----" << endl
            ...
            << "4- Listar itinerarios segun matriculas" << endl
            << "5- Listar itinerarios segun localidad" << endl
            << "6- Salir" << endl
            << "Elija una opcion: ";
        cin >> opc;
    } while(opc < 1 || opc > 6); ///Modificacion este 5 antes era un 4
...
int main() {
    ...
    do{
        ...
        case 1:
            ...
            case 4:
                ...
                for(int x = 0; x < a.getNautobuses(); x++){
                    autobus tmp = a.autobus_iesimo(x);
                    cout<< "-Matricula: " << tmp.matricula << "\tCapacidad: " << tmp.e.plazas << "\titv: " << (tmp.e.itv?"Si":"No") << "\tactivo: " << (tmp.e.activo?"Si":"No") << endl;
                    i.listaitixmatricula(tmp.matricula);
                    cout << endl;
                }
                system("PAUSE");
            break;
            case 5:
                ...
                cadena localidad;
                cout<< "                     Itinerarios-Horarios de viaje" << endl
                    << "--------------------------------------------------" << endl
                    << "Introduzca la localidad: ";
                cin >> localidad;

                cout << endl;
                i.viajeslocalidad(localidad);
                cout << endl;

                system("PAUSE");
            break;
            ///FIN DE LA MODIFICACION
            case 6: ///MODIFICACION: Este 6 antes era un 4
    ...
    }while(!(menu == 1 && opt == 6)); ///MODIFICACION el 6 antes era un 4
